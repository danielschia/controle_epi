    ...
    def ready(self):
        ...
        try:
            ...
            try:
                ...
                test_gerentes = [
                    {'username': 'gerente1', 'email': 'gerente1@example.local', 'nome': 'Gerente', 'sobrenome': 'Um', 'setor': 'RH', 'cpf': '00000000001'},
                    {'username': 'gerente2', 'email': 'gerente2@example.local', 'nome': 'Gerente', 'sobrenome': 'Dois', 'setor': 'Produção', 'cpf': '00000000002'},
                ]
